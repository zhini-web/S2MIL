...
def load_pretrained_weights(
    ...
    if os.path.isfile(pretrained_weights):
        #
        # state_dict = torch.load(pretrained_weights, map_location="cpu") # 弱监督
        state_dict = torch.load(pretrained_weights, map_location="cpu")['state_dict'] # 第二阶段RNN，Transformer等用
