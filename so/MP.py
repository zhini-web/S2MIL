...
class Moment_Probing_ViT(nn.Module):
    def __init__(self, cross_type='near', in_dim=384, hidden_dim=512, num_heads=4, num_tokens=197, num_blocks=2, num_classes=1000):
        super().__init__()
        ...
        self.classifier2 = nn.Linear(1587, num_classes)
    ...
    def forward(self, cls_token, x):
        ...
        # return torch.cat([cls_token, cross_cov], dim=1)


class Moment_Probing_WSI(nn.Module):
    def __init__(self, cross_type='near', in_dim=384, hidden_dim=384, num_heads=4, num_tokens=197, num_blocks=2, num_classes=2):
        super().__init__()
        self.cross_type = cross_type
        self.num_heads = num_heads
...
class Moment_Probing_Dino2ViT(nn.Module):
    def __init__(self, cross_type='near', in_dim=384, hidden_dim=512, num_heads=4, num_tokens=197, num_blocks=2, num_classes=1000):
    # def __init__(self, cross_type='near', in_dim=384, hidden_dim=384, num_heads=4, num_tokens=197, num_blocks=2, num_classes=1000):
        super().__init__()
        self.cross_type = cross_type
        self.num_heads = num_heads
