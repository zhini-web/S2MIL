...
from src.wsi_dataset import MILdataset
...
def get_args_parser():
    ...
    parser.add_argument(
        "--data_path",
        # default="/home/yht/yht/WSIMIL/dataset/c16/cnn_train_lib_4090.db",
        default="/home/yht/yht/WSIMIL/dataset/dino/dayi/cnn_train_data_lib_4090_23.db",
        type=str,
        help="""Please specify path to the ImageNet training data.""",
    )
    parser.add_argument(
        "--output_dir",
        default="/home/yht/mugs_dayi",
        type=str,
...
def train_mugs(args):
    ...
    #######################################################
    ckpt_path = '/home/yht/mugs/pre_weight/vit_small_800ep.pth'
    ckpt = torch.load(ckpt_path, map_location="cpu")
    print('student')
    msk = student.load_state_dict(ckpt['student'], strict=False)
    print('teacher')
    teacher.load_state_dict(ckpt['teacher'], strict=False)
    print('student_mem')
    student_mem.load_state_dict(ckpt['student_mem'], strict=False)
    print('teacher_mem')
    teacher_mem.load_state_dict(ckpt['teacher_mem'], strict=False)
